...
import org.integratedmodelling.thinkscape.gedit.model.commands.ShapeCreateCommand;
import org.integratedmodelling.thinkscape.gedit.model.commands.ShapeSetConstraintCommand;
...
public void propertyChange(PropertyChangeEvent evt) {
	...
	if (ModelDiagram.CHILD_ADDED_PROP.equals(prop)
			|| ModelDiagram.CHILD_REMOVED_PROP.equals(prop)) {
		refreshChildren();
	}
}
...
private static class ShapesXYLayoutEditPolicy extends XYLayoutEditPolicy {
	...
	protected Command createChangeConstraintCommand(ChangeBoundsRequest request,
		...
		if (child instanceof ShapeEditPart && constraint instanceof Rectangle) {
			...
			return new ShapeSetConstraintCommand(
					(ModelShape) child.getModel(), request, (Rectangle) constraint);
		}
	...
	protected Command getCreateCommand(CreateRequest request) {
		...
		if (childClass == EllipticalShape.class || childClass == RectangularShape.class) {
			...
			return new ShapeCreateCommand((ModelShape)request.getNewObject(), 
					(ModelDiagram)getHost().getModel(), (Rectangle)getConstraintFor(request));
		}
		return null;
	}
