...
 *******************************************************************************/
package org.integratedmodelling.thinkscape.gedit.model.commands;
 ...
 * </ol>
 * @see org.integratedmodelling.thinkscape.gedit.parts.ShapeEditPart#createEditPolicies() for an
 * 			 example of the above procedure.
 * @see org.eclipse.gef.editpolicies.GraphicalNodeEditPolicy
 * @see #setNewSource(ModelShape)
 * @see #setNewTarget(ModelShape)
...
private ModelShape newSource;
/** The new target endpoint. */
private ModelShape newTarget;
/** The original source endpoint. */
private final ModelShape oldSource;
/** The original target endpoint. */
private final ModelShape oldTarget;
 ...
 */
public void setNewSource(ModelShape connectionSource) {
 ...
 */
public void setNewTarget(ModelShape connectionTarget) {
