...
private class CreationPage extends WizardNewFileCreationPage {
	private static final String DEFAULT_EXTENSION = ".model";
	 ...
	 * @see ModelCreationWizard#init(IWorkbench, IStructuredSelection)
	 */
	...
	private Object createDefaultContent() {
		return new ModelDiagram();
	}
	
	/**
	 * This method will be invoked, when the "Finish" button is pressed.
	 * @see ModelCreationWizard#performFinish()
	 */
	boolean finish() {
