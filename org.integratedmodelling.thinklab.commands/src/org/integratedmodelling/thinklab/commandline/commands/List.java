...
@ThinklabCommand(
		name="list",
		description="list resources and their contents",
		optionalArgumentDefaultValues="__NONE__,__NONE__",
		optionalArgumentDescriptions="what to list,specific item to describe",
		optionalArgumentNames="subject,item",
		optionalArgumentTypes="thinklab-core:Text,thinklab-core:Text",
		optionDescriptions="list format",
		optionLongNames="lf",
		optionNames="l",
