package org.integratedmodelling.utils.log;
...
public class LogForwarder {
	...
	public LogForwarder(BundleContext bundleContext, String[] loggerNames) {
		this(bundleContext, loggerNames, null);
	}
	
	public LogForwarder(BundleContext bundleContext, String[] loggerNames, Handler defaultHandler) {
