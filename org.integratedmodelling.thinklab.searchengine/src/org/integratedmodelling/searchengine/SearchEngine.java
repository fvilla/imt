...
public final class SearchEngine implements IQueriable {
	...
	private IThinklabPlugin declaringPlugin;
...
//			}
    ...
    public void initialize() throws ThinklabException {
    	...
    	for (IOntology o : getOntologies()) {   		
    		SearchEnginePlugin.get().info("search engine: " + id + ": indexing " + o);     			
    			indexModel(o);
    	}
    ...
    public void indexModel(IOntology o) throws ThinklabException {
    	...
    	if (false && ontEntry.entryDate >= o.getLastModificationDate()) {
    		SearchEnginePlugin.get().info("searchengine: index of " + o + " is up to date: skipping");
    		return;
		}
    	...
    	for (IConcept c : o.getConcepts()) {
    		...
    		SearchEnginePlugin.get().info("searchengine: indexing concept " + c);
    		submitConcept(c);
    	}
    	...
    	if (indexIndividuals) {
    		for (IInstance i : o.getInstances()) {
    			// submit concept for indexing
    			SearchEnginePlugin.get().info("searchengine: indexing individual " + i);
    ...
    Document submitExternalResource(String uri) throws ThinklabException {
		...
		if (outfile == null || !outfile.exists()) {
			SearchEnginePlugin.get().warn("resource " + uri + " could not be found for indexing");
			return null;
		}
...
//			}
	...
	public void setResourceFinder(IThinklabPlugin resourceFinder) {
